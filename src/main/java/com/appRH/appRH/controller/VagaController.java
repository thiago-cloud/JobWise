...
public class VagaController {
	...
	public ModelAndView listaVagas() {
		...
		Iterable<Vaga>vagas = vr.findAll();//O findAll server para buscar tudo
		mv.addObject("vagas", vagas);//Estou mandando para minha view o vagas
		return mv;
	}
	...
	public String deletarVaga(long codigo) {
		Vaga vaga = vr.findByCodigo(codigo);//buscando a vaga através do codigo(id)
		vr.delete(vaga);
	...
	public String detalhesVagaPost(@PathVariable("codigo") long codigo, @Valid Candidato candidato, 
		...
		public String deletarCandidato(String rg){
			Candidato candidato = cr.findByRg(rg);//Vai procurar candidato pelo rg
